public class Pagamentos {
    ...
    public static void Pix(){
        ...
        System.out.print("\nValor a Pagar:\n R$20,49\n");
        System.out.print("Abra seu APP de Pagamento e Insira o Codigo Abaixo na Opção 'PIX COPIA E COLA':\n");
        ...
        do {
            ...
            switch (op){
                case 1:
                    ...
                    break;
                case 2:
                    System.out.print("AGUARDE E TENTE NOVAMENTE!");
                    Pix();
                    break;
            }
        }while (op < 0 || op > 2);
    ...
    public static void CartaoCredito(){
        ...
        if(senha1 == senha){
            ...
            Erros.PagamentoCreditoInvalido("Pagamento de Cartao de Credito Invalido");
            CartaoCredito();
        }
    ...
    public static void CartaoDebito(){
        ...
        if(senha1 == senha){
            ...
            System.out.print("SENHA INVALIDA! RETIRE O CARTÃO E TENTE NOVAMENTE!\n");
            Erros.PagamentoDebitoInvalido("Pagamento de Cartao de Debito Inválido");
            CartaoCredito();
        }
    }
    ...
    public static void Cedula(){
        double valor ;
            ...
            if(valor < 20.49){
                ...
                System.out.printf("PAGAMENTO EFETUADO COM SUCESSO!\nSEU TROCO É DE: R$ %.2f",(valor - 20.49),"\n");
                System.out.print("\n");
            }
    }

    public static void ReembolsoPIX(){
        double valor = 0.0;
